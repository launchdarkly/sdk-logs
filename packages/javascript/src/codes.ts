...
*/
export function dataSource_runtimeError_invalidJson(connection: string, _type: string): string {
 ...
 * @param _type The type of the message. For example "put", "patch", or "delete"
*/
export function dataSource_runtimeError_invalidPayload(connection: string, _type: string): string {
...
*/
export function client_runtimeWarning_missingInitTimeout(_function: string): string {
