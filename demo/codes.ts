...
*/
export function client_runtimeWarning_missingInitTimeout(fn: string): string {
  return `1:4:0 The ${fn} function was called without a timeout specified. In a future version a default timeout will be applied.`;
}
/**
 * Initialization, or a function to wait for initialization, was done without a timeout.
 *
